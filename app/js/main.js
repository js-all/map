...
}, popupEls = [], saveButton = document.getElementById('save'), gearButton = document.getElementById('gear-button'), topArrowButton = document.getElementById('tile-top-arrow'), bottomArrowButton = document.getElementById('tile-bottom-arrow'), tileNewButton = document.getElementById('tile-new-button'), gearCloseButton = document.getElementById('g-close'), gearInsCode = document.getElementById('ins-code'), gearSize = document.getElementById('g-in-size'), tileNewClose = document.getElementById('p-close'), tileNewSave = document.getElementById('p-save'), tileImage = document.getElementById('tile-image'), tileName = document.getElementById('tile-name'), tileNewNameIN = document.getElementById('p-in-name'), tileNewFileIN = document.getElementById('p-in-image'), tileNewBackgorund = document.getElementById('p-in-background'), gearFile = document.getElementById('g-in-file'), DATA = {
    json: {
        size: 100,
...
gearSize.addEventListener('change', e => {
    if (gearSize.value === "")
        ...
        DATA.json.size = parseFloat(gearSize.value);
});
...
gearInsCode.addEventListener('click', () => {
    const file = gearFile.files[0];
    if (gearFile.files.length === 0) {
        alert('no file');
        return;
    }
    const reader = new FileReader();
