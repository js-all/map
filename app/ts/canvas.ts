...
function adaptSize() {
    log(parseFloat(<string>getComputedStyle(<HTMLElement>document.getElementById('left-container')).width))
...
canvas.addEventListener('click', e => {
    ...
    let pos : [number, number] = [stepalize(mouseX - offset[0]),stepalize(mouseY - offset[1])];
